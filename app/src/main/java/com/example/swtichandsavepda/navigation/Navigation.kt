    ...
    NavHost(
        ...
        composable(Screen.PurchaseOrder.routeWithArgs, arguments = productArgs()) {
            ...
            PurchaseOrderScreen(
                ...
                onShowReceiptHistory = viewModel::showReceiptHistory,
                onRetryReceiptHistory = viewModel::retryReceiptHistory,
                onDismissReceiptHistory = viewModel::dismissReceiptHistory,
